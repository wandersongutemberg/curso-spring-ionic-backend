...
import com.wandersongutemberg.cursomc.domain.ItemPedido;
import com.wandersongutemberg.cursomc.domain.Pagamento;
import com.wandersongutemberg.cursomc.domain.PagamentoComBoleto;
import com.wandersongutemberg.cursomc.domain.PagamentoComCartao;
import com.wandersongutemberg.cursomc.domain.Pedido;
import com.wandersongutemberg.cursomc.domain.Produto;
import com.wandersongutemberg.cursomc.domain.enums.EstadoPagamento;
...
import com.wandersongutemberg.cursomc.repositories.ItemPedidoRepository;
import com.wandersongutemberg.cursomc.repositories.PagamentoRepository;
import com.wandersongutemberg.cursomc.repositories.PedidoRepository;
import com.wandersongutemberg.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "wanderson.gutembergs@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93839393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "wanderson_gut@hotmail.com", "10430219652", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363325","93839396"));
